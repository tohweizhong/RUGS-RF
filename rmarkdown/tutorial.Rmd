...
Besides tuning the __ntree__ hyperparameter, we might also be interested in tuning the __mtry__ hyperparameter in random forest:
...
The random forest model may be built using the __mtry__ value that minimises the OOB error.
